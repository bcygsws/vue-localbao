...
!(function(a, b) {
    ...
    (a.fn.on = function(b, d, e) {
      return this.each(function() {
        ...
        var g = !1,
          ...
          m = k[b] || (k[b] = {});
        if (
          (a.isEmptyObject(m) && (g = !0), (m[d] || (m[d] = [])).push(e), g)
        ) {
          var n = i[h(f)];
          n || (n = []);
          var o = j(f, b, d, e);
    ...
    (a.openWindow = function(b, f, g) {
      ...
      if (window.plus) {
        ...
        if (
          (a.webviews[f]
            ? ((l = a.webviews[f]),
              plus.webview.getWebviewById(f) && (k = l.webview))
      ...
      (a.openWindowWithTitle = function(b, f) {
        ...
        if (window.plus) {
          ...
          if (
            (a.webviews[h]
              ? ((m = a.webviews[h]),
                plus.webview.getWebviewById(h) && (l = m.webview))
            ...
            return (
              ...
              m &&
                ...
                l.evalJS(
                  m.afterShowMethodName + "('" + JSON.stringify(k) + "')"
                ),
              l
            );
          ...
          if (
            ...
            var o = a.options.titleConfig.id
                ? a.options.titleConfig.id
                : h + '_title',
  ...
  (function(a, b, c) {
    ...
    (a.ajax = function(d, e) {
      ...
      if (f.xhrFields) for (var w in f.xhrFields) t[w] = f.xhrFields[w];
              ...
              a.extend(
                {
                  ...
                  disablePulldownToRefresh: function() {
                    ...
                    'circle' == this.options.down.style
  ...
  (function(a, b, c, d) {
      ...
      r = (function() {
        ...
        return (
          ...
          b.addEventListener('tap', function(b) {
            ...
            c &&
              (c.addEventListener('webkitTransitionEnd', q),
    ...
    var t = function(a, b, d) {
        if (
          ...
          if (
            e &&
            (e.addEventListener('webkitTransitionEnd', q),
  ...
  (function(a, b, c, d, e) {
    var f = 'mui-control-item',
      ...
      j = function(a, b) {
        return (
          !(
            !b.classList ||
            (!b.classList.contains(f) && !b.classList.contains(i))
          ) &&
          ((b.parentNode &&
    ...
    a.registerTarget({ name: d, index: 80, handle: j, target: !1 }),
      b.addEventListener('tap', function(b) {
        ...
        if (e) {
          for (
            var g, j, k, l = 'mui-active', m = '.' + l, n = e.parentNode;
            n && n !== c;
            n = n.parentNode
          ) {
            ...
            n.classList.contains('mui-bar-tab') &&
              (g = n.querySelector(m + '.' + i));
          }
          ...
          if (
            ...
            if (!o) {
              ...
              k.classList.add(l);
              for (
                var s = [], t = p.querySelectorAll('.' + h), q = 0;
                q < t.length;
                q++
              )
        ...
        if (z) {
          ...
          if ('open' === d) {
            ...
            if (
              (E(A, i),
              void 0 !==
                (g = 'toLeft' === sliderDirection ? buttonsRight : buttonsLeft))
            ) {
          ...
          ~this.options.actions.indexOf('slider')
            ...
            : (~this.options.actions.indexOf('clear') &&
              ...
              ~this.options.actions.indexOf('search') &&
                ((this.searchActionClass = i), (this.searchActionSelector = p)),
        ...
        return (
          this.each(function() {
            ...
            if (g) b = a.data[g];
              ...
              (g = ++a.uuid),
                (b = a.data[g] = new s(this, { actions: d.join(',') }));
    ...
    (f.prototype.initEvent = function() {
      ...
      (f.prototype.handleScroll = function(d) {
        ...
        (f = Math.min(Math.max(this._A, f), 1)),
          ...
          this.lastOpacity !== f &&
            (a.trigger(this.element, 'alpha', { alpha: f }),
            (this.lastOpacity = f));
      }),
